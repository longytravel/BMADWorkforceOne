...
- [ ] Create Dashboard or HeatmapPage component (AC: 1, 2, 3, 4)
  - [ ] Create src/pages/Dashboard.tsx (or similar page component)
  - [ ] Add page title: "Capacity vs Demand Heatmap"
  - [ ] Add subtitle/description: "Real-time coverage visualization across 7 days"
  - [ ] Import and render CvDHeatmap component
  - [ ] Apply layout with appropriate spacing and padding
  - [ ] Use Tailwind for responsive design

- [ ] Integrate with App.tsx (AC: 1, 4)
  - [ ] Import Dashboard/HeatmapPage in src/App.tsx
  - [ ] Wrap with AppShell component (from Story 1.5)
  - [ ] Ensure proper layout hierarchy: AppShell > Dashboard > CvDHeatmap
  - [ ] Remove any placeholder heatmap integration from Story 2.2

- [ ] Add loading state handling (AC: 5)
  - [ ] Check Zustand store isLoading state
  - [ ] Display loading skeleton while demo data loads
  - [ ] Use Shadcn Skeleton component or custom loading spinner
  - [ ] Ensure smooth transition from loading → loaded

- [ ] Add error state handling (AC: 6)
  - [ ] Check Zustand store error state
  - [ ] Display user-friendly error message if data load fails
  - [ ] Add "Retry" button that calls store.resetDemo()
  - [ ] Log error to console for debugging

- [ ] Implement responsive layout (AC: 7)
  - [ ] Test heatmap on desktop (1920x1080)
  - [ ] Test heatmap on laptop (1366x768)
  - [ ] Test heatmap on tablet (768x1024)
  - [ ] Adjust container sizing using Tailwind responsive classes
  - [ ] Ensure heatmap cells remain readable at all sizes

- [ ] Add navigation (AC: 8)
  - [ ] Update Header component (from Story 1.5) with navigation link
  - [ ] Add "Heatmap" or "Dashboard" link
  - [ ] Highlight active navigation item
  - [ ] Note: If app is single-page, this may be a visual indicator only

- [ ] Add page metadata and accessibility
  - [ ] Set document title: "CvD Heatmap - WFM Intelligence Demo"
  - [ ] Add page-level aria-label
...
- [ ] Write integration tests
  ...
  - [ ] Test retry button triggers data reload
